...
class Settings {
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Utilice la versión de java suministrada con el launcher';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Utilice la versión de java suministrada con el launcher';
            file.value = '';
